...
package com.intellij.python.pytools.frontend.icons;
 ...
 */
public final class PythonPytoolsFrontendIcons {
  private static @NotNull Icon load(@NotNull String path, int cacheKey, int flags) {
    return IconManager.getInstance().loadRasterizedIcon(path, PythonPytoolsFrontendIcons.class.getClassLoader(), cacheKey, flags);
  }
  ...
  public static final class UI {
    public static final class Expui {
      /** 16x16 */ public static final @NotNull Icon Edit = load("icons/com/intellij/python/pytools/ui/expui/edit.svg", 222657426, 0);
      /** 16x16 */ public static final @NotNull Icon Install = load("icons/com/intellij/python/pytools/ui/expui/install.svg", -198452315, 0);
      /** 16x16 */ public static final @NotNull Icon Settings = load("icons/com/intellij/python/pytools/ui/expui/settings.svg", 1980199675, 0);
      /** 16x16 */ public static final @NotNull Icon Upgrade = load("icons/com/intellij/python/pytools/ui/expui/upgrade.svg", 1098395947, 0);
    }
  }
}
